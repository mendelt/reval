...
### Added
- `for .. in .. map ..` list iteration
- `for .. in .. filter ..` list filtering
- `any` and `all` functions

### Removed
- User function evaluation results are not cached anymore
...
[unreleased]: https://github.com/mendelt/reval/compare/v0.11.0-rc.0...HEAD
[0.11.0-rc.0]: https://github.com/mendelt/reval/compare/v0.10.2...v0.11.0-rc.0
